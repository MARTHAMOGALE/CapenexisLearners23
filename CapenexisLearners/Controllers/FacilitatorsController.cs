...
namespace CapenexisLearners.Controllers
{
    public class FacilitatorsController : Controller
    {
        ...
        public FacilitatorsController(CapenexisLearnersContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Facilitators != null ? 
                          ...
                          Problem("Entity set 'CapenexisLearnersContext.Facilitators'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CapenexisLearnersContext.Facilitators'  is null.");
            }
            var facilitators = await _context.Facilitators.FindAsync(id);
            if (facilitators != null)
            {
